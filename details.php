				...
				<div class="product-details"><!--product-details-->
					...
					if(isset($_GET['item_ID'])){
						...
						$pro_id = $_GET['item_ID'];
							...
							$fetch_pro = " SELECT * FROM `tblitem` WHERE itemID = $pro_id ";
							// if($fetch_pro) {
							// 	echo "success";
							// }

							$run_pro = mysqli_query($connect, $fetch_pro);
							...
							<div class="col-sm-5">
							   <div class="view-product">
							       <img height='380' width='380' src="pro_img/<?php echo $pro_img; ?>" alt="Image is loading" />
							       <h3><a href="land.php"  style="text-decoration:none;">Go Back </a></h3>
							    </div>
					  	</div>
							...
							<div class="col-sm-7">
									<div class="product-information"><!--/product-information-->
											...
											<span>
												...
												<label>Quantity: <?php echo  $pro_qunt ?></label>
												<h3> </h3>
											...
											<p><b>Description:</b><?php echo $pro_desc?></p>
