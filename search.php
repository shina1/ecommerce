				...
				<div class="col-sm-8 padding-right">
			    	<div class="features_items"><!--Searched_items-->
                        ...
                        if(isset($_GET['search'])){
                            ...
                            $noResult = "NO RESULT FOUND FOR THIS ITEM";
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<a href="cart.php ? itm_ID=$pro_id" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
										</div>
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										...
										<li><a href="cart.php ? itm_ID = $pro_id"><i class="fa fa-plus-square"></i>Add to compare</a></li>
									</ul>
								</div>
							</div>
						</div>
                            ...
                            <?php }} ?>
                            <div> <p> <?php echo $noResult;?></P></div>
					
					<?php }?>
					
					</div><!--Searched_items-->
					<!--category-tab-->
					<!-- i deleted the category code to create more space for the searched items on the search page . I can decide to add them back in future if need be -->
                    <!--/category-tab-->
