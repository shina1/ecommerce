...
<body>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="#Sell_form">Sell Products</a>  </li>
	...
	<section>
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
					<div class="left-sidebar" id="Sell_form">
						<h2>Sell Your Products</h2>
						<div class="panel-group category-products" id="accordian"><!--selling form-->
							
							<form action="insert_product.php" method="post" enctype="multipart/form-data" >
								<!-- <script type="text/javascript">
									var col = document.getElementByTagName("h4");
									function add() {
										col.style.color="red"
									}

								</script> -->
								<table width="210" border="2" class="sell_table" >
									<tr style="background-color:#FE980F; color: #ffff">
										<td colspan="10">
									...
									<tr align="center">
										<!-- <td>Product Tile</td>  -->
										<td><input type="text" name="ItemName" placeholder="Product Title" required>  </td>
										
									</tr>
									<tr align="center">
										<!-- <td>Product category</td> -->
										<td>
											<select name="pro_cat" style="width: 175px;" required>
												<option >Select a category</option>

												<?php 
												$get_cats = "SELECT catID, All_cat FROM tblcategory  "; 
												$run_cats = mysqli_query($connect, $get_cats);
												while ($row_cats = mysqli_fetch_array($run_cats)
												) {
													$cat_id = $row_cats['catID'];
													$cat_title = $row_cats['All_cat'];
													// the value here is very important cos its the cat_id that will be passed to pro_cat name for inserting into the database.
										 ...
										 <tr align="center">
											...
											<!-- <td>Product brand</td> -->
										<td><input   type="text" name="pro_brand"  placeholder="Brand Name" required> </td>
									...
									<!-- <tr align="center">
										<td>Product brand</td>
										<td><input type="text" name="pro_brand" placeholder="Product Brand">  </td>
										
									</tr> -->
									<tr align="center">
										<!-- <td>Product image</td> -->
										<td><input type="file" name="pro_img" placeholder="Product Image" style="padding-left:10px" required>  </td>
										
									</tr>
									<tr align="center">
										<!-- <td>Product quantity</td> -->
										<td><input style="width: 175px;"  type="number" name="ItemNumber" min="0" max="100" step="1" placeholder="Quantity of Products" required> </td>
										
									</tr>
									<tr align="center">
										<!-- <td>Product price</td> -->
										<td><input type="text" name="pro_price" placeholder="Product price" required>  </td>
									</tr>
									<tr align="center">
										<!-- <td>Product keyword</td> -->
										<td><input type="text" name="pro_key" placeholder="Keyword" required>  </td>
									</tr>
									<tr align="center">
										<!-- <td>Product Description</td> -->
										<td><textarea  name="pro_descript" placeholder="Brief Description" cols="20" rows="3" style="width:250px"></textarea>  </td>
									</tr>
